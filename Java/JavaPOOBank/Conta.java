...
public abstract class Conta {
	...
	/*
	 * Método responsável por retornar o número da agência da conta.
	 * 
	 * @return int agencia: número da agência da conta.
	 */
	 ...
	 * 
	 * @return int conta: Número da conta bancária do cliente.
	 */
	public int getConta() {
		return this.conta;
	}
	...
	/*
	 * Método responsável por retornar o saldo disponível.
	 * 
	 * @return float saldo: Saldo disponível na conta do cliente.
	 */
	...
	/*
	 * Método responsável retornar o score da conta bancária do cliente.
	 * 
